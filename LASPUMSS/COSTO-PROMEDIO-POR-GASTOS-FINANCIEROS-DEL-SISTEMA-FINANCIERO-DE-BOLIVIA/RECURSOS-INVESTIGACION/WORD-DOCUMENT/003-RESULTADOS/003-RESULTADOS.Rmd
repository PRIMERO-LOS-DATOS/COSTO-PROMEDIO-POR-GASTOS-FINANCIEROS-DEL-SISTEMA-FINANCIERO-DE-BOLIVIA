...
Ahora bien, se presentan los resultados encontrados:

```{r, fig.id='resultados001Figura', fig.cap='Ratios de sub partidas de gastos financieros, respecto a pasivos correspondientes del periodo 2020-01-28 a 2023-12-28',  fig.width=6.02, fig.height=7.33}
...
```{r, fig.id='resultados002Figura', fig.cap='Obligaciones con empresas públicas, obligaciones con el público, valores en circulación, intereses oficina central - sucursales y comisiones oficina central y sucursales, correspondientes al periodo 2020-01-28 a 2023-12-28',  fig.width=6.02, fig.height=7.4}
ids <- c('CD_280_00',
         'CD_210_00',
         'CD_260_00',
         'CD_414_02',
...
```{r, tab.id='resultados001Tabla', tab.cap='Costo promedio de sub partidas de gastos financieros, respecto a pasivos correspondientes del periodo 2020-01-28 a 2023-12-28'}
ids <- c(
         'CD_411_00_SOBRE_CD_210_00',
         'CD_412_00_SOBRE_CD_220_00',
         'CD_413_00_SOBRE_CD_230_00',
